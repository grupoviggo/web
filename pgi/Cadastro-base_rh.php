...
<?php include 'submenu.php'; ?>
        ...
        <div class="content">
            <br>
            <div class="panel">
                <h2><i class="fa-solid fa-pen-to-square"></i> Cadastrar Base
            ...
            <div class="panel2">
                ...
                <form method="POST" action="cadastro_base" class="p-4 rounded">
                    <div class="mb-3">
                        <label for="CONSULTOR_BASE_NOME" class="form-label">Base:</label>
                        <input type="text" class="form-control" name="CONSULTOR_BASE_NOME"
                            placeholder="Insira o nome da base" maxlength="50" style="text-transform: uppercase;"
                            oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '').toUpperCase()" required>
                    </div>

                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button type="submit" class="btn btn-success">Cadastrar</button>
                        <a href="Bases" class="btn btn-primary">Consultar/Editar Bases</a>
                        <a href="carga-lotecolaboradores" class="btn btn-secondary">Cancelar</a>
                        <!-- <a href="carga-lotecolaboradores_" class="btn btn-warning">Subir em Lote</a> -->
                    </div>
