...
if (isset($_GET['id'])) {
    ...
    $query = "UPDATE dados_colaborador SET STATUS_COLABORADOR = 'INATIVO' WHERE id = $id";

    if (mysqli_query($connect, $query)) {
        $statusAtualizado = true; // Atualização bem-sucedida
    } else {
        echo "<p class='alert alert-danger'>Erro ao inativar colaborador: " . mysqli_error($connect) . "</p>";
    }
} else {
