...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="navbar-text text-light ml-3 small"> <!-- Adiciona a classe small para diminuir o texto -->
            <span class="label-text">usuário: &nbsp;</span><strong><?php echo $_SESSION['nome']; ?></strong> <!-- Nome do usuário -->
            <br>
            <span class="label-text">logado: &nbsp;</span><span id="tempo-logado"><?php echo $tempo_online_formatado; ?></span> <!-- Tempo logado -->
        </div>
            ...
            <ul class="navbar-nav ml-auto">s
                <li class="nav-item">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <button class="btn btn-warning btn-sm btn-voltar" type="submit" onclick="window.location.href='paineltfp'; return false;">VOLTAR AO MENU</button>
                    </form>
                </li>
            </ul>
        </div>
    ...
    <div class="container mt-4">
        <h3 class="text-center mb-4">FAZER UPLOAD DA PLANILHA DA CAMPANHA</h3>
        <br>
        <form action="upload_campanha" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label for="campanhaUpload">Selecione o arquivo (.xlsx ou .csv)</label>
        <input type="file" class="form-control-file" id="campanhaUpload" name="campanhaUpload" required>
    </div>
