...
<body>
        ...
        <div class="menu-item dropdown-rh">
            ...
            <div class="submenu" id="submenurh">
                ...
                <a class="page-link">Opção de Cadastro</a>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <br>
            <div class="panel">
                <h2><i class="fa-solid fa-pen-to-square"></i> Cadastros
            ...
            <div class="panel2">
                ...
                <div class="favorites">
                    ...
                    <div class="favorite-item" style="max-width: 400px;">
                        <form id="uploadForm" class="fv-item-fomr" action="upload" method="post"
                            enctype="multipart/form-data">
                            <i class="fa-solid fa-desktop"></i>
                            <label for="fileUpload">Cadastro em Lote</label>
                            <input type="file" id="fileUpload" name="fileUpload" required>
                        </form>
                    </div>

                    <!-- <div class="favorite-item" style="max-width: 400px;">
                        <form id="uploadCampanhaForm" class="fv-item-fomr" action="upload_campanha.php" method="post"
                            enctype="multipart/form-data">
                            <i class="fa-solid fa-desktop"></i>
                            <label for="campanhaUpload">Cadastro Campanha</label>
                            <input type="file" id="campanhaUpload" name="campanhaUpload" required>
                            <button type="submit">Enviar</button>

                        </form>
                    </div> -->

                    <div class="favorite-item" style="max-width: 400px;" onclick="toggleSubmenu(this)">
                        <i class="fa-solid fa-shapes"></i>
                        <p>Cadastrar Base</p>
                        <div class="submenu-card">
                            <hr>
                            <a href="Cadastro-base_rh.php" class="page-link">Cadastrar</a>
                            <a href="Bases.php" class="page-link">Verificar Bases</a>
                        </div>
                    </div>
                    ...
                    <div class="favorite-item" style="max-width: 400px;" onclick="toggleSubmenu(this)">
                        ...
                        <div class="submenu-card">
                            <hr>
                            <a href="formulario_produto.php" class="page-link">Cadastrar</a>
                            <a href="Bases.php" class="page-link">Verificar Produtos</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        <!-- <script>
        document.getElementById('campanhaUpload').addEventListener('change', function () {
            document.getElementById('uploadCampanhaForm').submit();
        });
    </script> -->
</body>
<script>
