...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <i class="fa-solid fa-house active">
        ...
        <div class="menu-item dropdown">
            ...
            <div class="submenu" id="submenu">
                ...
                <div class="submenu-section">
                    ...
                    <div class="submenu-items submenu-specific">
                        <a href="#" class="page-link">Gestão de venda</a>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <br>
            <div class="panel">
                <h2><i class="fas fa-chart-bar"></i> Painel Principal
            ...
            <div class="panel2">
                ...
                <!-- Conteúdo do painel -->
                <div class="favorites">
                    <div class="favorite-item" onclick="toggleSubmenu(this)">
                    ...
                    <div class="favorite-item" onclick="toggleSubmenu(this)">
                        ...
                        <div class="submenu-card">
                            <hr>
                            <a href="importar_zip" class="page-link">Importação PAP</a>
                            <a href="fila" class="page-link">Fila de vendas</a>
                            <a href="posvenda" class="page-link">Pós venda</a>
                        </div>
                    </div>

                    <div class="favorite-item" onclick="toggleSubmenu(this)">
                        <i class="fi fi-sr-boss"></i>
                        <p>Comercial</p>
                        <!-- <div class="submenu-card">
                            <hr>
            ...
            <div class="custom-panel">
                ...
                <div class="service-cards">
                    <div class="service-card">
                        <img src="../img/viggo_1100_Cor.png" style="height: auto;" alt="">
                        <h3><a href="https://brandfactory.telefonica.com/share/fZ5FRh5RpLr8UG1ouyMr"
                                target="_blank">Lâminas de Ofertas</a></h3>
                        <span class="text-card">Acesso as lâminas atualizadas</span>
                    </div>
                    <div class="service-card">
                        <img src="../img/papmobile.png" style="height: auto;" alt="">
                        <h3><a href="https://papmobile.before.com.br/" target="_blank">Pap Mobile</a></h3>
                        <span class="text-card">Acesse rapidamente o Pap mobile</span>
                    </div>
                    <div class="service-card">
                        <img src="../img/viggo_blue.png" style="height: auto;" alt="">
                        <h3><a href="#">Serviço 3</a></h3>
                    </div>
                </div>
            </div>
