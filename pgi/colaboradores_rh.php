...
$query = "SELECT id, NOME, CPF, DT_NASCIMENTO, DT_ADMISSAO, cargo, STATUS_COLABORADOR,CONSULTOR_BASE_NOME FROM dados_colaborador";
if (!empty($busca)) {
    ...
    <div class="sidebar" id="sidebar">
            ...
            <div class="submenu" id="submenu">
                ...
                <div class="submenu-section">
                    ...
                    <div class="submenu-items submenu-specific">
                        ...
                        <a onclick="window.location.href='paineltfp.php'" class="page-link">TFP</a>
        ...
        <div class="menu-item dropdown-rh">
            ...
            <div class="submenu" id="submenurh">
                ...
                <a class="page-link">Gestão de usuários</a>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="panel">
                <div class="header-container_3">
                    <h2 style="margin: 0;"><i class="fa-solid fa-list-check"></i> Lista de Colaboradores</h2>
                    <div class="button-container">
                        <form method="GET" class="d-flex align-items-center gap-6 custom-form">
                            <input type="text" name="busca" class="form-control search-input" placeholder=" Buscar por CPF ou Nome"
                            ...
                            <button type="button" class="btn btn-secondary eraser-btn" style="width: 60px;" onclick="window.location.href='colaboradores_rh.php'">
                    ...
                    <tbody>
                        ...
                        if ($temResultados) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='no-left-border-left'>" . htmlspecialchars($row['NOME']) . "</td>";
                                echo "<td id='no-right-border'>" . htmlspecialchars($row['CPF']) . "</td>";
                                echo "<td id='no-right-border'>" . htmlspecialchars($row['CONSULTOR_BASE_NOME']) . "</td>";
                                echo "<td id='no-right-border'>" . htmlspecialchars($row['cargo']) . "</td>";
                                echo "<td id='no-right-border'>" . htmlspecialchars($row['STATUS_COLABORADOR']) . "</td>";
        ...
        <div class="modal fade" id="confirmAtivarModal" tabindex="-1" aria-labelledby="confirmAtivarModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Tem certeza de que deseja ativar este colaborador?
                    </div>
                    <div class="modal-footer">
        ...
        <script>
            function confirmarInativacao(id) {
                var confirmar = confirm("Tem certeza de que deseja inativar este colaborador?");
                if (confirmar) {
                    window.location.href = "inativar_colaborador.php?id=" + id;
                }
            }

            function confirmarAtivacao(id) {
                var confirmar = confirm("Tem certeza de que deseja ativar este colaborador?");
                if (confirmar) {
                    window.location.href = "ativar_colaborador.php?id=" + id;
                }
            }
        </script>
        ...
        <script>
            ...
            function confirmarInativacao(id) {
                ...
                $('#confirmInativarBtn').data('id', id); // Armazena o ID no botão de confirmação
            }

            // Função para abrir o modal de confirmação de ativação e armazenar o ID
            function confirmarAtivacao(id) {
                $('#confirmAtivarModal').modal('show');
                $('#confirmAtivarBtn').data('id', id); // Armazena o ID no botão de confirmação
            }
