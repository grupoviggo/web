...
<div class="sidebar" id="sidebar">
    ...
    <div class="main-content">
        ...
        <div class="content">
            <br>
            <div class="panel">
                <h2><i class="fa-solid fa-pen-to-square"></i> Painel TFP
            ...
            <div class="panel2">
                ...
                <div class="favorites">
                    <div class="favorite-item" style="max-width: 400px;">
                        <i class="fa-solid fa-desktop page-link"></i>
                        <p>Painel Gerencial</p>
                    </div>

                    <div class="favorite-item page-link" style="max-width: 400px;" onclick="window.location.href='tfp-database.php'">
                        <i class="fa-solid fa-list-check"></i>
                        <p>Base de Clientes</p>
                    </div>

                    <div class="favorite-item" style="max-width: 400px;">
                        <i class="fa-solid fa-book page-link"></i>
                        <p>Histórico (LOG)</p>
                    </div>
                </div>
            </div>
