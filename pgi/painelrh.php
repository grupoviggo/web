...
<body>
        ...
        <div class="menu-item dropdown-rh">
            ...
            <div class="submenu" id="submenurh">
                <a class="page-link">Cadastro de colaboradores</a>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="panel">
                <h2><i class="fas fa-user-plus"></i> Cadastro de colaborador
            ...
            <div class="panel2" style="overflow: hidden; max-height: 532px;">
                <form method="POST" action="cadastro_colaborador" class="p-4 bg-light rounded bg-custom">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cpf" name="CPF" placeholder="000.000.000-00"
                                    maxlength="14" style="height: 38px;" oninput="mascaraCPF(this)" required>
                            </div>

                            <div class="mb-3">
                                <label for="email" class="form-label">E-mail:</label>
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="email@exemplo.com" maxlength="50" style="height: 38px;" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3"> <label for="telefone" class="form-label">Telefone:</label> <input
                                    ...
                                    oninput="mascaraTelefone(this)"> </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="cargo" name="cargo" style="height: 38px;" required autocomplete="off">
                                    <option value="" selected>Selecione um perfil</option>
                                    <option value="ADMINISTRATIVO">ADMINISTRATIVO</option>
                                    <option value="COMERCIAL">COMERCIAL          </option>
                                    <option value="AUDITORIA">BKO/AUDITORIA  </option>
                                    <option value="POSVENDA">BKO/PÓS-VENDA  </option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="departamento" name="departamento" style="height: 38px;" required autocomplete="off">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        ...
                        <a href="colaboradores_rh" class="btn btn-primary ms-2">Ver Usuários</a>
                    </div>
                </form>
            </div>
