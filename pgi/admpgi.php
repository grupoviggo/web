...
<div class="login-container">
    <img src="../img/pgiloginbd.png" alt="NEXUS VIGGO">
    
    <form method="POST" action="loginbdpgi">
    ...
    <div class="footer">
        <img src="../img/poweredbinexus.png" class="footer-img" alt="powered by power bi">
    </div>
</div>
