            ...
            <div class="content">
                <div class="panel" style="padding: 0px !important;">
                    <div class="header-container">
                        <h2>&nbsp;<i class="fi fi-ss-trophy-star" style="font-size: 24px;"></i> Parabéns
                ...
                <div class="panel2">
                    <h5 class="form-header">RANKING BACKOFFICES</h5>
                    <img src="../img/rankingb.png" class="img-fluid" style="max-width: 80%;">
                </div>

                <!-- Botões abaixo do formulário -->
                <div class="d-flex justify-content-end mt-3">
                    <button type="button" onclick="window.location.href='fila.php'"
                        class="btn btn-success text-white fw-bold">ENCERRAR COM ORGULHO</button>
                </div>
