...
<body oncontextmenu="return false;">
    ...
    <div class="iframe-container" style="margin-left: -6px;">
        <iframe id="powerBIframe" title="DASHBOARD FATURAMENTO" width="1510" style="overflow: hidden;" src="sec_dash_fat_v2" frameborder="0" scrolling="NO" allowFullScreen="true" allowtransparency="true"></iframe>
        </div>
