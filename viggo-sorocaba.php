...
if ($nivel_acesso == 1 && $usuario != 'weslly.mena@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VIGGO SOROCABA</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO SOROCABA" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiMmFkOGJhY2QtNzFkMy00NTU0LTkzZTQtMWRjMGMyZDRmNWFkIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
