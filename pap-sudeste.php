...
// Verifica se o nível é 1 e o usuário não é 
if ($nivel_acesso == 1 && $usuario != 'thiago.arengue@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - PAP SUDESTE</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO PAP SUDESTE" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiYzI2NzkzMzgtYzU5YS00OWI1LWE4NzMtNjBmYzZkMmU5ZGZmIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
