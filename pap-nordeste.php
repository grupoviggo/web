...
if ($nivel_acesso == 1 && $usuario != 'cleber.henrique@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - PAP NORDESTE</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO PAP NORDESTE" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiZTkzNDNiOWYtNWRjMy00OTI0LWIyNzItZmM4OWY3NzQwYjIwIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
