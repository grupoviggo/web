...
<div class="container">
        ...
        <br><br>
        <div>
            <a href="horaresumotv" class="button black-button">RESUMO REGIONAL   </a>
            <a href="horasptv" class="button blue-button">SÃO PAULO DDD 11   </a>
            <a href="horafsptv" class="button orange-button">SP DDD 13 - 19 & FSP</a>
            <br><br><br>
        </div>
    </div>
