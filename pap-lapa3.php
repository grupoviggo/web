...
// Verifica se o nível é 1 e o usuário não é 'everton.almeida@grupoviggo.com.br' ou 'juliane.santos@grupoviggo.com.br'
if ($nivel_acesso == 1 && !in_array($usuario, ['afonso.batestin@grupoviggo.com.br', 'juliane.santos@grupoviggo.com.br'])) {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VIGGO LAPA III</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO LAPA III" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiZTMyYjRhNzktNjUzMS00NDZlLTgwMTQtMGM3YmFkN2MzOTQ0IiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
