...
<head>
    ...
    <title>ETL - VISÃO DE DADOS M1</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="iframe-container" style="margin-left: -6px;">
        <iframe id="powerBIframe" title="Dashboard Base VIGGO" width="1510" style="overflow: hidden;" src="sec_dash_etldw" frameborder="0" scrolling="NO" allowFullScreen="true" allowtransparency="true"></iframe>
        </div>
