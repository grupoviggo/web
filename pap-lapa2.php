...
if ($nivel_acesso == 1 && !in_array($usuario, ['itamar.borges@grupoviggo.com.br', 'juliane.santos@grupoviggo.com.br'])) {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VIGGO LAPA II</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO LAPA II" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiNWE5MzFmN2EtMWJhZi00YmJlLWE3Y2YtNjdmYTI5ZmE1ZWRkIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
