...
if ($nivel_acesso == 1 && $usuario != 'laerte.lima@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - REGIONAL SPi</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO REGIONAL SPI" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiMzU2ODk2OGMtODc0NC00YWUyLWE5ZTUtYTExMzUzY2QxMjZjIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
