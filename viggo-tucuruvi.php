...
if ($nivel_acesso == 1 && !in_array($usuario, ['teste@grupoviggo.com.br', 'ronaldo.siqueira@grupoviggo.com.br'])) {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VIGGO TUCURUVI</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO TUCURUVI" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiZjE0NDZjZWUtZWUwYi00YmNjLTllNGMtZDAwYTgzZWRiMjA1IiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
