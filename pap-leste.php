...
// Verifica se o nível é 1 e o usuário não é 'rodrigo.campos@grupoviggo.com.br'
if ($nivel_acesso == 1 && $usuario != 'rodrigo.campos@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - PAP LESTE</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO PAP LESTE" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiMDJjZmFlMmItMGVmMi00YmQwLWJjNGYtMDBjZDI3MjNhNzk4IiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
