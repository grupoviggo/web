...
if ($nivel_acesso == 1 && !in_array($usuario, ['everton.almeida@grupoviggo.com.br', 'juliane.santos@grupoviggo.com.br'])) {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VIGGO LAPA I</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO LAPA I" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiOTdmYzcwMzYtMmI2YS00ZmUyLWIwMTMtZGNkMzc5MTQ5ZDY4IiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
