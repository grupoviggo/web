...
if ($nivel_acesso == 1 && $usuario != 'adilange.costa@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VILA MATILDE III</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO VILA MATILDE III" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiZjQzZjRhZjMtOGQ3OC00MjZhLWJiODMtZWE3YjExNGIwNGIzIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
