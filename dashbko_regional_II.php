...
<div class="bar-direita" style="margin-right: 6px;"></div>
    <div class="iframe-container" style="margin-left: -6px;">
        <iframe id="powerBIframe" title="DASHBOARD BKO II" width="1024" height="1060" src="sec_dash_bko2" frameborder="0" allowFullScreen="true"></iframe>
    </div>
