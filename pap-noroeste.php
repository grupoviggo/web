...
if ($nivel_acesso == 1 && $usuario != 'caio.damaceno@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - PAP NOROESTE</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO PAP NOROESTE" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiYTI0YzExNDMtOTEwYS00NzgzLTk0YTQtMDU3YzJkMjljMzNhIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
