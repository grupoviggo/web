...
if ($nivel_acesso == 1 && $usuario != 'patricia.lima@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VIGGO CAMPINAS</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO CAMPINAS" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiNjUxMjFjN2QtMGY0ZC00MmE4LWFmYzYtZjc1MjRmNTRlOGRlIiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
