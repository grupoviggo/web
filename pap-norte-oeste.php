...
// Verifica se o nível é 1 e o usuário não é 'usuario@grupoviggo.com.br'
if ($nivel_acesso == 1 && $usuario != 'marcelo.noriake@grupoviggo.com.br') {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - PAP NORTE & OESTE</title>
    ...
    <div class="navbar-collapse">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                    ...
                    <button class="btn btn-warning btn-sm btn-voltar"  onclick="history.back(); return false;">VOLTAR</button>
            </li>
        </ul>
    </div>
</nav>
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO PAP NORTE E OESTE" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiM2M0ZDA4OTYtY2U1YS00NmNmLTg0ZGItYjg3NDVmMmRjNGY0IiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
