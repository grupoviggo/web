...
if ($nivel_acesso == 1 && !in_array($usuario, ['teste@grupoviggo.com.br', 'luciano.francisco@grupoviggo.com.br'])) {
    header("Location: menu");
    exit();
}
...
<head>
    ...
    <title>DASHBOARD - VIGGO LAPA</title>
...
<div class="bar-direita" style="margin-right: 0px;"></div>
    <div class="iframe-container" id="iframe-container">
        <iframe title="VIGGO LAPA" width="1510" src="https://app.powerbi.com/view?r=eyJrIjoiMjVlOWYwYWEtMDU3Yi00NGM2LThjNzYtMDhlNWQ0NzE4OTk3IiwidCI6ImU0YjUyYWNhLTQzNmItNDhmMC05NGY1LWFhM2U2ZmIzZDVjYiJ9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
